...
public class newcustomerview extends javax.swing.JFrame {
    ...
    public static void setCustomer(Customer customer) {
        newcustomerview.customer = customer;
    }
    ...
    public static void setWorker(Worker worker) {
        newcustomerview.worker = worker;
    }
    
    
    public newcustomerview() {
        initComponents();
        System.out.println("新顾客预定房间界面启动");
    }
    ...
    private void initComponents() {
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "注意", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("华文楷体", 1, 15))); // NOI18N

        jLabel6.setFont(new java.awt.Font("华文楷体", 1, 18)); // NOI18N
        jLabel6.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel6.setText("请先保留顾客信息，再进行预定！");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        //book=new Book();
        book.setCname(jTextField1.getText());
        book.setCphone(jTextField2.getText());
        book.setCidcard(jTextField3.getText());
        //数据库对预定表更新
